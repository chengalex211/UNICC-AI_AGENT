...
const CouncilReview: FC = () => {
  const [expanded, setExpanded] = useState<number | null>(0)
  const { council_critiques } = detailedEval
  ...
  return (
    <div className="p-8 space-y-6 animate-fade-in">
      ...
      <div>
        ...
        <p className="text-sm text-apple-gray-400">Cross-expert critique and arbitration · {detailedEval.system_name}</p>
      </div>
